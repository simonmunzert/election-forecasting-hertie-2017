...
p_needed <- c("readr", # imports spreadsheet data
              ...
              "babynames", # data set compiled by Hadley Wickham; contains US baby names provided by the SSA and data on all names used for at least 5 children of either sex
