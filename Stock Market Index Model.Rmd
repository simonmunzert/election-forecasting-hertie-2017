...
GFE <- read_dta('~/hertie-election-forecasting (Akira)/BundestagForecastReplicationData.dta')
GFE_Kayser <- read_dta('~/hertie-election-forecasting (Akira)/data/ger_nat.dta')
